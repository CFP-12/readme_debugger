...
from src.pydoccheck.execution.result import ExecutionResult
from src.pydoccheck.execution.statistics import ExecutionStats
...
def generate_html_report(self, output_path: Path) -> None:
    ...
    <div class="flex-section">
        <div class="section chart-area">{{ chart_div | safe }}</div>
